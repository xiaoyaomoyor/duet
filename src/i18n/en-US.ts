...
export default {
  ...
  compare: {
    ...
    showNote: 'Show note',
    anonymize: 'Anonymise',
    anonymousTool: 'Tool {n}',
    anonymizeHint:
      'Images and read-only pages keep fields masked. Click a black box to reveal it temporarily. Project files retain the original information for editing.',
    anonymizeName: 'Mask the tool name',
    anonymizeVersion: 'Mask the version',
    anonymizeIcon: 'Mask the logo (show a black block)',
  ...
  inspector: {
    ...
    chainAnonymizeHint:
      'When on, clicking any masked field reveals or re-masks every masked field on that side (name / version / logo) at once.',
    spotlightOff: 'Off',
