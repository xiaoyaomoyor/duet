...
**v0.6.0 · R1 展示样板**：通过顶栏调色板按钮、空项目页的“展示样板”或 `#/showcase` 打开。提供墨色／纸白双主题、五类场景、真实试听与统一窗口，支持干净画面及方向键切换。

![R1 试听舞台](docs/screenshots/r1-stage-ink.png)

设计规则和验收见 [R1 视觉规范与验收](docs/04-R1视觉规范与验收.md)。样板内素材与文字修改仅在当前页面保留；现有项目全面接入新界面安排在 R2。
